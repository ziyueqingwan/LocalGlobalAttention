...
from ultralytics.nn.modules.LocalGlobalAttention import *
from ultralytics.nn.modules.ShuffleAttention import *
from ultralytics.nn.modules.CA import *
from ultralytics.nn.modules.MHSA import *
from ultralytics.nn.modules.MobileNetV3 import *
from ultralytics.nn.modules.CBAM import *
from ultralytics.nn.modules.SEAttention import *
from ultralytics.nn.modules.ECAAttention import *
from ultralytics.nn.modules.ResNet import *
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, Blocks):
            ...
            if args[1][:10] in 'Bottleneck':
                ...
                args = [c1, c2, *args[1:]]
        elif m is (LocalGlobalAttention, MHSA, CoordAtt):
            c1, c2 = ch[f], args[0]
            if c2 != nc:
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, *args[1:]]
